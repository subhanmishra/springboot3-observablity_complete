...
//        var one = User.withDefaultPasswordEncoder().roles("admin").username("subhan").password("password").build();
//        var two = User.withDefaultPasswordEncoder().roles("user").username("elina").password("password").build();
